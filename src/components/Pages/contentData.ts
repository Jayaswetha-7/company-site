...
export const contentData: Record<string, ContentData> = {
    ...
    additionalHeadings: [
...

      {
        ...
        },
        {
          ...
          paragraph:
            "services.additionalHeadings.cybersecurity.paragraph",//"Protect your business with end-to-end security solutions, ensuring compliance, data protection, and resilience against cyber threats.",
            details: [
...

          {
            ...
            paragraph:
            "services.additionalHeadings.smartindustry.paragraph",//"Harness the power of IoT and smart technology to improve efficiency, reduce costs, and automate critical business processes.",
            details: [
          ...
          },
          {
            ...
            paragraph:
              "services.additionalHeadings.blockchain.paragraph",//"Blockchain technology enables secure, transparent, and tamper-proof transactions across various industries. Our solutions include:",
              details: [
            ...
            },
            {
              ...
              paragraph:
                "services.additionalHeadings.enterpricesoftware.paragraph",//"From enterprise resource planning (ERP) to intelligent automation, we help businesses optimize operations with cutting-edge software solutions.",
                details: [
              ...
              },
              {
                ...
                paragraph:
                  "services.additionalHeadings.talent.paragraph",//"Our strategic consulting services help businesses build a strong digital foundation, streamline operations, and align IT with business goals.",
                  details: [
  ...
  security: {
    ...
    additionalParagraph:
      "security.additionalParagraph",//"Comprehensive Cybersecurity Solutions for Your Business",
          ...
          paragraph:
...

           {
...

            {
              ...
              paragraph:
                "security.headings.threatProtection.paragraph",//"We use intelligent detection and response systems to counter sophisticated cyber threats, minimizing risks and ensuring continuous protection.",
                details: [
...

               {
...

                {
                  ...
                  paragraph:
                  "security.headings.infrastructure.paragraph", //"Our mission is to fortify your business against cyber threats. With our world-class security solutions, we help you protect sensitive information and ensure operational resilience.",
                    details: [
  ...
  network: {
    ...
    additionalParagraph:
       "network.additionalParagraph",//"Building a Strong Foundation for Your Business",
    extraContent:
      "network.extraContent",//"How can you operate a successful business without a solid foundation? Our Infrastructure & Networking Technology team develops end-to-end solutions to build a robust framework for our clients’ businesses. This encompasses everything from architecture design right through to project implementation and managed services.",
    ...
    additionalHeadings: [
      ...
      },
      {
        ...
        },
        {
          ...
          paragraph:
            "network.headings.infrastructure.paragraph",//"Data Centers Preparation, power, cooling and racks, Data Center Infrastructure Management (DCIM), Intelligent Data Center Enablement, Turnkey MEP works, Testing and certifying data centers (Data Center All Tier (Uptime), IT infrastructure availability and resilience (part of Business Continuity),Health check and data center gap analysis), Maintenance and Managed services for data centers and command centers.",
            details: [
          ...
          },
          {
            ...
            paragraph:
              "network.headings.audiovisual.paragraph",//"E-learning solutions, Video walls, Auditoriums, Preparation of digital meeting rooms Display systems, Public address systems, Command and control centers preparation (including NOC and SOC)",
              details: [
            ...
            },
            {
              ...
              paragraph:
                "network.headings.security.paragraph",//"Perimeter Fence (HCIS Class 1, 2, 3, 4 & 5) and Crash Rated Anti- Vehicle Barrier, Physical Security Equipment (Road Blockers, Arm Barriers, Turnstiles, Bollards...)., Screening & Searching Equipment (Explosive Detectors, Baggage Scanner, Metal Detectors, Walk-through Detectors, UVIS, ANPR...), Intrusion Detection & Assessment System (IDAS) including Volumetric Sensors (Microwave) & Fence Mounted Fiber Sensors., Long Range Detection & Assessment Systems (LRDAS) including Long.",
                details: [
...

      {
        ...
        },
        {
          ...
          paragraph:
            "network.headings.communication.paragraph",//"Structured Cabling Systems, Outside Plants (OSP), Telecommunication shelters, Indoor GSM solutions.",
            details: [
