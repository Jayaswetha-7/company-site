...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-200/5 to-indigo-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

      <motion.div
        whileHover={{ rotate: 360 }}
        transition={{ duration: 0.5 }}
        className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-300 to-indigo-600 rounded-2xl mb-6 shadow-lg"
      >
