...
import { Waves, Shield, Network, Brain, ArrowRight, Mail, Phone, Linkedin } from 'lucide-react';
...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-20 pb-32 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 overflow-hidden">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.1 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative">
          ...
          >
            ...
            >
              tap<span className="text-blue-400">hubs</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Connecting innovation with possibility. We create seamless digital experiences 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeIn}>
              ...
              <p className="text-gray-600 mb-4">
                As a forward-thinking technology company, we're committed to delivering 
                innovative solutions that drive digital transformation. Our team of experts 
                brings together years of experience in various tech domains.
              </p>
              <p className="text-gray-600">
                We believe in staying ahead of the curve, continuously learning and 
                adapting to new technologies to provide our clients with the best 
                possible solutions for their unique challenges.
              </p>
            </motion.div>
            <motion.div 
              className="relative"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              technology and innovation. Join us in shaping the future of digital solutions.
            </p>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            <p className="text-gray-600">
              We're currently building our team. Check back soon for exciting opportunities 
              or send us your resume for future considerations.
            </p>
          </motion.div>
        </div>
      </section>
